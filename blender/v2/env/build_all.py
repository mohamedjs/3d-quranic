...
render(PREV + 'env_houses.png', camera('ShowHouses', (16, -24, 9), (12, 0, 2.5), lens=30))
render(PREV + 'env_trees.png', camera('ShowTrees', (14, -34, 5), (14, -12, 3.5), lens=30))
render(PREV + 'env_props.png', camera('ShowProps', (18, -36, 4.5), (18, -24, 0.8), lens=30))
render(PREV + 'env_small.png', camera('ShowSmall', (12, -44, 2.2), (12, -36, 0.3), lens=30))
render(PREV + 'env_plants.png', camera('ShowPlants', (8, -52.5, 1.4), (8, -48, 0.3), lens=30))
